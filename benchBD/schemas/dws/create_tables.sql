...
CREATE TABLE IF NOT EXISTS finance_accounts (
    ...
    CONSTRAINT pk_finance_accounts PRIMARY KEY (account_id)
);
...
CREATE TABLE IF NOT EXISTS finance_transactions (
    ...
    description TEXT,
    create_time TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT pk_finance_transactions PRIMARY KEY (transaction_id)
);
...
CREATE TABLE IF NOT EXISTS internal_transactions (
    ...
    create_time TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT pk_internal_transactions PRIMARY KEY (internal_id)
);
...
CREATE TABLE IF NOT EXISTS distribution_channels (
    ...
    region VARCHAR(50),
    create_time TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT pk_distribution_channels PRIMARY KEY (channel_id)
);
...
CREATE TABLE IF NOT EXISTS distribution_performance (
    ...
    create_time TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT pk_distribution_performance PRIMARY KEY (performance_id)
);
